    ...
    class Options
      ...
      def set_banner
        ...
        parser.banner = <<-BANNER.gsub(/^[ ]+/, '')
          ...
          See https://wiki.github.com/troessner/improve_your_code for detailed help.
      ...
      def set_configuration_options
        ...
        parser.on('--smell SMELL',
                  ...
                  'Call it like this: improve_your_code --smell PrimaDonnaMethod source.rb',
                  'Check out https://github.com/troessner/improve_your_code/blob/master/docs/Code-Smells.md '\
      ...
      def set_utility_options
        ...
        parser.on_tail('-v', '--version', 'Show version') do
          puts "#{parser.program_name} #{ImproveYourCode::Version::STRING}\n"
          exit
        end
      end
    end
