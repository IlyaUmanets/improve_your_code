...
module ImproveYourCode
  ...
  #
  # :improve_your_code:TooManyMethods: { max_methods: 31 }
  # :improve_your_code:UnusedPrivateMethod: { exclude: [ !ruby/regexp /process_/ ] }
  # :improve_your_code:DataClump
  class ContextBuilder
    ...
    # node is always ImproveYourCode::Context::RootContext. Using the example above,
    # the tree would look like this:
    #
    # RootContext -> children: 1 ModuleContext -> children: 1 MethodContext
    #
    # @return [ImproveYourCode::Context::RootContext] tree of nested contexts
