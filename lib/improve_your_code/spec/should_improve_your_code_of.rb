  ...
  module Spec
    class ShouldImproveYourCodeOf
      ...
      def set_failure_messages_for_smell_type
        self.failure_message = "Expected #{origin} to improve_your_code of #{smell_type}, "\
          'but it didn\'t'
        self.failure_message_when_negated = "Expected #{origin} not to improve_your_code "\
      ...
      def set_failure_messages_for_smell_details
        ...
        self.failure_message_when_negated = "Expected #{origin} not to improve_your_code of "\
