...
require_lib 'improve_your_code/smell_detectors/unused_parameters'

RSpec.describe ImproveYourCode::SmellDetectors::UnusedParameters do
  it 'reports the right values' do
    ...
    expect(src).to improve_your_code_of(:UnusedParameters,
                           lines:   [1],
                           context: 'alfa',
  ...
  it 'does count all occurences' do
    ...
    expect(src).
      to improve_your_code_of(:UnusedParameters, lines: [1], name: 'bravo').
      and improve_your_code_of(:UnusedParameters, lines: [1], name: 'charlie')
  end

  it 'reports nothing for no parameters' do
    src = 'def alfa; end'
    expect(src).not_to improve_your_code_of(:UnusedParameters)
  end
  ...
  it 'reports for 1 used and 2 unused parameter' do
    ...
    expect(src).
      to not_improve_your_code_of(:UnusedParameters, name: 'bravo').
      and improve_your_code_of(:UnusedParameters, name: 'charlie').
      and improve_your_code_of(:UnusedParameters, name: 'delta')
  end
