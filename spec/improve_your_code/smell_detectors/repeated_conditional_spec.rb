...
require_lib 'improve_your_code/smell_detectors/repeated_conditional'

RSpec.describe ImproveYourCode::SmellDetectors::RepeatedConditional do
  it 'reports the right values' do
    ...
    expect(src).to improve_your_code_of(:RepeatedConditional,
                           lines:   [5, 9, 13],
                           context: 'Alfa',
  ...
  it 'does not report two repeated conditionals' do
    ...
    expect(src).not_to improve_your_code_of(:RepeatedConditional)
  end
