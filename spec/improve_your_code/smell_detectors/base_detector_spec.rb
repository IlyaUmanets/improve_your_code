...
RSpec.describe ImproveYourCode::SmellDetectors::BaseDetector do
  describe '.todo_configuration_for' do
    ...
    context 'with default exclusions present' do
      let(:subclass) { ImproveYourCode::SmellDetectors::TooManyStatements }
  ...
  describe '.to_detector' do
    it 'returns the right detector' do
      expect(described_class.to_detector('DuplicateMethodCall')).to eq(ImproveYourCode::SmellDetectors::DuplicateMethodCall)
    end
  ...
  describe '.configuration_keys' do
    it 'returns the right keys' do
      expected_keys = ImproveYourCode::SmellDetectors::DuplicateMethodCall.configuration_keys.to_a
