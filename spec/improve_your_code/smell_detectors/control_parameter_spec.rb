...
require_lib 'improve_your_code/smell_detectors/control_parameter'

RSpec.describe ImproveYourCode::SmellDetectors::ControlParameter do
  it 'reports the right values' do
    ...
    expect(src).to improve_your_code_of(:ControlParameter,
                           lines:    [2],
                           context:  'alfa',
  ...
  it 'does count all occurences' do
    ...
    expect(src).
      to improve_your_code_of(:ControlParameter, lines: [2], argument: 'bravo').
      and improve_your_code_of(:ControlParameter, lines: [3], argument: 'charlie')
  end
  ...
  context 'when a parameter is not used to determine code path' do
    it 'does not report a ternary check on an ivar' do
      ...
      expect(src).not_to improve_your_code_of(:ControlParameter)
    end
