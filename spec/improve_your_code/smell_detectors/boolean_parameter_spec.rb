...
require_lib 'improve_your_code/smell_detectors/boolean_parameter'

RSpec.describe ImproveYourCode::SmellDetectors::BooleanParameter do
  it 'reports the right values' do
    ...
    expect(src).to improve_your_code_of(:BooleanParameter,
                           lines: [1],
                           context: 'alfa',
  ...
  it 'does count all occurences' do
    ...
    expect(src).
      to improve_your_code_of(:BooleanParameter, lines: [1], context: 'alfa', parameter: 'bravo').
      and improve_your_code_of(:BooleanParameter, lines: [1], context: 'alfa', parameter: 'charlie')
  end
  ...
  context 'when examining an instance method' do
    ...
    it 'reports two parameters defaulted to booleans in a mixed parameter list' do
      ...
      expect(src).to improve_your_code_of(:BooleanParameter, parameter: 'charlie').
        and improve_your_code_of(:BooleanParameter, parameter: 'delta').
        and not_improve_your_code_of(:BooleanParameter, parameter: 'bravo').
        and not_improve_your_code_of(:BooleanParameter, parameter: 'echo')
    end

    it 'reports keyword parameters defaulted to booleans' do
      src = 'def alfa(bravo: true, charlie: false) end'
      expect(src).
        to improve_your_code_of(:BooleanParameter, parameter: 'bravo').
        and improve_your_code_of(:BooleanParameter, parameter: 'charlie')
    end

    it 'does not report regular parameters' do
      src = 'def alfa(bravo, charlie) end'
      expect(src).not_to improve_your_code_of(:BooleanParameter)
    end
