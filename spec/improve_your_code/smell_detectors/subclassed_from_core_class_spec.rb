...
require_lib 'improve_your_code/smell_detectors/subclassed_from_core_class'

RSpec.describe ImproveYourCode::SmellDetectors::SubclassedFromCoreClass do
  it 'reports the right values' do
    ...
    expect(src).to improve_your_code_of(:SubclassedFromCoreClass,
                           lines:    [1],
                           context:  'Alfa',
  ...
  it 'reports when inheriting from a core class inside a module' do
    ...
    expect(src).to improve_your_code_of(:SubclassedFromCoreClass, context: 'Alfa::Bravo')
  end
  ...
  it 'does not report when not inheriting from a core class' do
    ...
    expect(src).not_to improve_your_code_of(:SubclassedFromCoreClass)
  end
