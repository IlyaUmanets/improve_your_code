...
require_lib 'improve_your_code/smell_detectors/long_parameter_list'

RSpec.describe ImproveYourCode::SmellDetectors::LongParameterList do
  it 'reports the right values' do
    ...
    expect(src).to improve_your_code_of(:LongParameterList,
                           lines:   [2],
                           context: 'Alfa#bravo',
  ...
  it 'does count all occurences' do
    ...
    expect(src).
      to improve_your_code_of(:LongParameterList, lines: [2], context: 'Alfa#bravo').
      and improve_your_code_of(:LongParameterList, lines: [5], context: 'Alfa#golf')
  end

  it 'reports nothing for 3 parameters' do
    src = 'def alfa(bravo, charlie, delta); end'
    expect(src).not_to improve_your_code_of(:LongParameterList)
  end
