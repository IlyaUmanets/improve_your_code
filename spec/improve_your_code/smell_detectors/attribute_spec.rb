...
require_lib 'improve_your_code/smell_detectors/attribute'

RSpec.describe ImproveYourCode::SmellDetectors::Attribute do
  it 'reports the right values' do
    ...
    expect(src).to improve_your_code_of(:Attribute,
                           lines: [2],
                           context: 'Alfa#bravo',
  ...
  it 'does count all occurences' do
    ...
    expect(src).
      to improve_your_code_of(:Attribute, lines: [2], context: 'Alfa#bravo').
      and improve_your_code_of(:Attribute, lines: [3], context: 'Alfa#charlie')
  end
  ...
  it 'records nothing with no attributes' do
    ...
    expect(src).not_to improve_your_code_of(:Attribute)
  end
  ...
  context 'with attributes' do
    ...
    it 'records writer attribute' do
      ...
      expect(src).to improve_your_code_of(:Attribute, context: 'Alfa#bravo')
    end
    ...
    it 'resets visibility in new contexts' do
      ...
      expect(src).to improve_your_code_of(:Attribute, context: 'Charlie#delta')
    end
