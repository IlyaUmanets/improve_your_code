...
RSpec.describe ImproveYourCode::SmellDetectors::ManualDispatch do
  it 'reports the right values' do
    ...
    expect(src).to improve_your_code_of(:ManualDispatch,
                           lines:   [3],
                           context: 'Alfa#bravo',
  ...
  it 'does count all occurences' do
    ...
    expect(src).
      to improve_your_code_of(:ManualDispatch, lines: [3], context: 'Alfa#bravo').
      and improve_your_code_of(:ManualDispatch, lines: [7], context: 'Alfa#delta')
  end
  ...
  it 'reports occurences in a single method as one smell warning' do
    ...
    expect(src).to improve_your_code_of(:ManualDispatch, lines: [3, 4], context: 'Alfa#bravo')
  end
end
