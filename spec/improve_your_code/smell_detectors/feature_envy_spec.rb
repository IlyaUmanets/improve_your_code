...
require_lib 'improve_your_code/smell_detectors/feature_envy'

RSpec.describe ImproveYourCode::SmellDetectors::FeatureEnvy do
  it 'reports the right values' do
    ...
    expect(src).to improve_your_code_of(:FeatureEnvy,
                           lines:   [3, 3],
                           context: 'Alfa#bravo',
  ...
  it 'does count all occurences' do
    ...
    expect(src).
      to improve_your_code_of(:FeatureEnvy, lines: [3, 3], name: 'charlie').
      and improve_your_code_of(:FeatureEnvy, lines: [7, 7], name: 'hotel')
  end

  it 'does not report use of self' do
    src = 'def alfa; self.to_s + self.to_i; end'
    expect(src).not_to improve_your_code_of(:FeatureEnvy)
  end
  ...
  it 'report highest affinity' do
    ...
    expect(src).
      to improve_your_code_of(:FeatureEnvy, name: 'delta').
      and not_improve_your_code_of(:FeatureEnvy, name: 'bravo')
  end
  ...
  it 'reports multiple affinities' do
    ...
    expect(src).
      to improve_your_code_of(:FeatureEnvy, name: 'delta').
      and improve_your_code_of(:FeatureEnvy, name: 'bravo')
  end
  ...
  it 'is not fooled by duplication' do
    ...
    expect(src).to improve_your_code_only_of(:DuplicateMethodCall, name: 'bravo.echo')
  end
  ...
  it 'reports many calls to lvar' do
    ...
    expect(src).to improve_your_code_only_of(:FeatureEnvy)
  end
