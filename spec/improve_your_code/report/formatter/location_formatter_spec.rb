...
RSpec.describe ImproveYourCode::Report::Formatter::BlankLocationFormatter do
...
RSpec.describe ImproveYourCode::Report::Formatter::DefaultLocationFormatter do
  let(:warning) { build(:smell_warning, lines: [11, 9, 250, 100]) }
...
RSpec.describe ImproveYourCode::Report::Formatter::SingleLineLocationFormatter do
  let(:warning) { build(:smell_warning, lines: [11, 9, 250, 100]) }
