...
require_lib 'improve_your_code/report/code_climate/code_climate_configuration'

RSpec.describe ImproveYourCode::Report::CodeClimateConfiguration do
  yml = described_class.load
  smell_types = ImproveYourCode::SmellDetectors::BaseDetector.descendants.map do |descendant|
