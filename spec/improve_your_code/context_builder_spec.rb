...
require_lib 'improve_your_code/context_builder'

RSpec.describe ImproveYourCode::ContextBuilder do
  describe '#context_tree' do
    ...
    it 'starts with a root node' do
      ...
      expect(context_tree).to be_a(ImproveYourCode::Context::RootContext)
    end
    ...
    describe 'the root node' do
      it 'has one module_context' do
        expect(module_context).to be_a(ImproveYourCode::Context::ModuleContext)
      end
    ...
    describe 'the module node' do
      it 'has one method_context' do
        expect(method_context).to be_a(ImproveYourCode::Context::MethodContext)
  ...
  describe '#context_tree' do
    it 'creates the proper context for all kinds of singleton methods' do
      ...
      syntax_tree = ImproveYourCode::Source::SourceCode.from(src).syntax_tree
      ...
      expect(start_method).to be_instance_of ImproveYourCode::Context::SingletonMethodContext
      expect(drive_method).to be_instance_of ImproveYourCode::Context::SingletonMethodContext
    end
    ...
    it 'returns something sensible for nested metaclasses' do
      ...
      expect(method_context).to be_instance_of ImproveYourCode::Context::SingletonMethodContext
    ...
    it 'returns something sensible for nested method definitions' do
      ...
      bar_context = foo_context.children.first
      expect(bar_context).to be_instance_of ImproveYourCode::Context::MethodContext
    ...
    it 'returns something sensible for method definitions nested in singleton methods' do
      ...
      bar_context = foo_context.children.first
      expect(bar_context).to be_instance_of ImproveYourCode::Context::SingletonMethodContext
      expect(bar_context.parent).to eq foo_context
    end
  end
end
