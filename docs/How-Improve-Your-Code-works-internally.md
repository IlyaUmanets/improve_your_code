# How ImproveYourCode works internally


## The big picture

```
["class C; end" | improve_your_code]            [improve_your_code lib/*.rb]                             [expect(files).not_to improve_your_code_of(:LargeClass)]
             \                            |                                                          |
              \                           |                                                          |
               \                          |                                                          |
                \             creates a   |                                                          |
                    ...
                    \                     |                                                          |
                     \---------- Application (cli/application.rb) +                                  |
                              ...
                              creates a   |                                                          |
                                          ...
                                          |                                                          |
                                          |                                                          |
                                ImproveYourCodeCommand (cli/improve_your_code_command)                                       |
...
The core foundation of ImproveYourCode and its API is the Examiner.
...
The overall workflow is like this:
    ...
    Generate the AST out of the given source using SourceCode#syntax_tree, which works like this:
      ...
      - We pass this unprocessed AST and the comment_map to TreeDresser#dress which
        returns an instance of ImproveYourCode::AST::SexpNode with type-dependent SexpExtensions mixed in.
    ...
    of Parser::AST::Node but of ImproveYourCode::AST::SexpNode and with node-dependent SexpExtensions
    mixed in (noted in []):
