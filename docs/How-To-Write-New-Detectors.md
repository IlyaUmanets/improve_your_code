...
All smell detectors reside in `lib/improve_your_code/smell_detectors` and have the following base structure:
...
For your detector to be properly loaded you need to require it in `lib/improve_your_code/smell_detectors.rb` as well.

### defaults.improve_your_code
...
for the first time with your shiny new detector in place the `defaults.improve_your_code`
